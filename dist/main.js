...
const SearchBoxContainer = (props) => {
    ...
    // function getData () {  
    //   props.uxpContext.executeAction("E3D","DistrictJump",{},{json:true}).then(res=>{ 
    //       console.log("District",res);
    //       setData(res);
    //   }).catch(e=>{
    //   }); 
    ...
    const handleResultClick = (result) => {
        ...
        if (uxpContext.eventHandler) {
            ...
            (_a = uxpContext.eventHandler) === null || _a === void 0 ? void 0 : _a.call(uxpContext, index_1.EventsEnum.DistrictJump, { sectorName: 'Al Wabra Dist' });
        }
    };
