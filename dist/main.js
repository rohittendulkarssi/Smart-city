            ...
            react_1.default.createElement("div", { className: 'status-content' },
                react_1.default.createElement(recharts_1.ResponsiveContainer, { width: "100%", height: 280 },
                    react_1.default.createElement(recharts_1.AreaChart, { width: 500, height: 350, data: water_consumption_data, margin: {
                        ...
                        react_1.default.createElement(recharts_1.Area, { type: "monotone", fill: "url(#gradient1)", dataKey: "AQI_index", stroke: "#001912", activeDot: { r: 8 } })))))));
};
    ...
    return (react_1.default.createElement(components_1.WidgetWrapper, { className: "smart-city_box iaq-box compare-iaq" },
        ...
        react_1.default.createElement("div", { className: "smart-city-content" },
            ...
            react_1.default.createElement("div", { className: "smart-city-content" },
                ...
                react_1.default.createElement("div", { className: 'status-content' },
                    react_1.default.createElement(recharts_1.ResponsiveContainer, { width: "100%", height: 230 },
...
const StreetLightStatusChart = () => {
    ...
    return (react_1.default.createElement("div", { className: "smart-city-content" },
        react_1.default.createElement("div", { className: "technician_chart", style: { height: 220 } },
    ...
    return (react_1.default.createElement(components_1.WidgetWrapper, { className: "smart-city_box power-by-box" },
        react_1.default.createElement("div", { className: 'header-content' },
            react_1.default.createElement("div", { className: 'power-by-cont' },
                react_1.default.createElement("p", null,
                    react_1.default.createElement("sub", null, "Power By")),
                react_1.default.createElement("div", { className: 'raseel_logo' })))));
};
...
const Street_Light__Status_Widget = () => {
    ...
    function fetchData() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const { data } = yield axios_1.default.get(`https://mda.lucyday.io/Lucy/TataStreetLightAPI/getAlertSummary?hierarchy=${hierarchy}`, { headers });
    ...
    (0, react_1.useEffect)(() => {
        const fetchData = () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                const response = yield axios_1.default.get('https://mda.lucyday.io/Lucy/TataStreetLightAPI/getInstalledVsWorkingLamps', headers);
    ...
    return (react_1.default.createElement(components_1.WidgetWrapper, { className: "smart-city_box waste-bin-box" },
        ...
        react_1.default.createElement("div", { className: "smart-city-content" },
            react_1.default.createElement("div", { className: 'status-content' }, isLoading ? (streetLightData.map((item) => (react_1.default.createElement("div", { key: item.id, className: `status ${item.clname}` },
                react_1.default.createElement("h3", null, " -- "),
                react_1.default.createElement("p", null, item.name))))) : (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement("div", { className: "technician_chart" },
                ...
                react_1.default.createElement("div", { className: "progress-bar-container" }, lampdata ? (react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement("div", { className: "progress-bar installedLamps", style: { width: `${Number(calculatePercentage(Number(lampdata.ilm.installedLamps), Number(lampdata.ilm.installedLamps) + Number(lampdata.ilm.workingLamps)))}%` } }),
                    react_1.default.createElement("div", { className: 'progress-bar working-lamps', style: { width: `${Number(calculatePercentage(Number(lampdata.ilm.workingLamps), Number(lampdata.ilm.installedLamps) + Number(lampdata.ilm.workingLamps))) < 10 ? 10 : Number(calculatePercentage(Number(lampdata.ilm.workingLamps), Number(lampdata.ilm.installedLamps) + Number(lampdata.ilm.workingLamps)))}%` } }))) : (react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement("p", null, "Loading data")))),
                react_1.default.createElement("div", { className: 'chart-sec' }, lampdata ? (react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement("div", { className: 'chart-issue' },
                        react_1.default.createElement("h3", null, lampdata.ilm.installedLamps),
                        react_1.default.createElement("p", null, "Installed lamps")),
                    react_1.default.createElement("div", { className: 'chart-pending' },
                        react_1.default.createElement("h3", null, lampdata.ilm.workingLamps),
                        react_1.default.createElement("p", null, "Working lamps")))) : (react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement("p", null, "Loading lamp Data..."))))),
            react_1.default.createElement("div", { className: "smart-city-content" },
...
const TopNavTabs = (props) => {
    ...
    const handleTabClick = (label) => {
        ...
        if (page) {
            (_a = uxpContext.eventHandler) === null || _a === void 0 ? void 0 : _a.call(uxpContext, index_1.EventsEnum.Navigation, { page: page.id });
        }
    };
    return (react_1.default.createElement(components_1.WidgetWrapper, { className: "smart-city_box" },
        react_1.default.createElement("div", { className: "top-nav-tabs" },
            react_1.default.createElement("ul", { id: "navList" }, Object.values(tabs).map((tab) => (react_1.default.createElement("li", { key: tab.id, className: `nav-link ${tab.className} ${activeTab === tab.label ? 'active' : ''}`, onClick: () => handleTabClick(tab.label) },
...
const VehicleSummaryWidget = () => {
    ...
    function fetchData() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const { data } = yield axios_1.default.get(`https://mda.lucyday.io/Lucy/TataStreetLightAPI/getAlertSummary?hierarchy=${encodeURIComponent(hierarchy)}`, { headers });
                setHealth(data);
            }
            catch (error) {
                console.error('Error fetching data from API:', error.message);
    ...
    const radarChartData = [
        { vehicle: 'AC Voltage', value: Number((_a = health === null || health === void 0 ? void 0 : health.ilmAlerts) === null || _a === void 0 ? void 0 : _a["AC Voltage"]) || 0 },
        { vehicle: 'Load Fail', value: Number((_b = health === null || health === void 0 ? void 0 : health.ilmAlerts) === null || _b === void 0 ? void 0 : _b["Load Fail"]) || 0 },
        { vehicle: 'Lux Sensor Blocked', value: Number((_c = health === null || health === void 0 ? void 0 : health.ilmAlerts) === null || _c === void 0 ? void 0 : _c["Lux Sensor Blocked"]) || 0 },
        { vehicle: 'Main Fail', value: Number((_d = health === null || health === void 0 ? void 0 : health.ilmAlerts) === null || _d === void 0 ? void 0 : _d["Main Fail"]) || 0 },
        { vehicle: 'Partial Failure', value: Number((_e = health === null || health === void 0 ? void 0 : health.ilmAlerts) === null || _e === void 0 ? void 0 : _e["Partial Failure"]) || 0 },
        { vehicle: 'Power Factor', value: Number((_f = health === null || health === void 0 ? void 0 : health.ilmAlerts) === null || _f === void 0 ? void 0 : _f["Power Factor"]) || 0 },
    ];
    return (react_1.default.createElement(components_1.WidgetWrapper, { className: "smart-city_box vehicle_summary-box" },
...
const Waste_Generated_Trend = () => {
    ...
    return (react_1.default.createElement(components_1.WidgetWrapper, { className: "smart-city_box energy_consumption-box" },
        ...
        react_1.default.createElement("div", { className: "smart-city-content" },
            react_1.default.createElement("div", { className: "technician_chart", style: { height: 245 } },
                react_1.default.createElement("div", { className: 'chart-top' },
                ...
                react_1.default.createElement(recharts_1.ResponsiveContainer, { width: "100%", height: "100%" },
                    react_1.default.createElement(recharts_1.BarChart, { width: 500, height: 180, data: selectedData, margin: {
                            top: 2, right: 0, left: 0, bottom: 2,
                        } },
                        react_1.default.createElement(recharts_1.CartesianGrid, { strokeDasharray: "0 0" }),
                        react_1.default.createElement(recharts_1.XAxis, { dataKey: "name" }),
