...
const SunController = (props) => {
    ...
    return (react_1.default.createElement("div", { className: 'timer-widget' },
        react_1.default.createElement("div", { className: 'timer-slider' },
            react_1.default.createElement("input", { className: 'timer-range', type: "range", min: 0, max: 24, step: 1, value: currentTime, onChange: handleTimeChange, 
                //onClick={() => uxpContext.eventHandler?.(EventsEnum.Zoom, { 'mode': '+' })}
                //onClick={() => uxpContext.eventHandler?.(EventsEnum.Zoom, { 'mode': '+' })}
                onClick: () => { var _a; return (_a = uxpContext.eventHandler) === null || _a === void 0 ? void 0 : _a.call(uxpContext, index_1.EventsEnum.SunPosition, { time: '12:15' }); } }),
...
(function (EventsEnum) {
    ...
    EventsEnum["SunPosition"] = "solar-time"; //sample payload - { 'time' : '12:15' }
