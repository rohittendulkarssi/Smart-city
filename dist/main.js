...
/***/ "./src/components/SunController.tsx.tsx":
/*!**********************************************!*\
  !*** ./src/components/SunController.tsx.tsx ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const SunController = (props) => {
    ...
    const handleTimeChange = (e) => {
        ...
        (_a = uxpContext.eventHandler) === null || _a === void 0 ? void 0 : _a.call(uxpContext, index_1.EventsEnum.SunPosition, { mode: 'time', time: newTime });
    };
    return (react_1.default.createElement("div", { className: 'timer-widget' },
        react_1.default.createElement("div", { className: 'timer-slider' },
            react_1.default.createElement("input", { className: 'timer-range', type: "range", min: 0, max: 24, step: 1, value: currentTime, onChange: handleTimeChange, onClick: () => { var _a; return (_a = uxpContext.eventHandler) === null || _a === void 0 ? void 0 : _a.call(uxpContext, index_1.EventsEnum.SunPosition, { time: '12:15' }); } }))));
};
        ...
        react_1.default.createElement("div", { className: 'weather-list' },
            react_1.default.createElement("ul", null,
                react_1.default.createElement("li", null,
                    react_1.default.createElement("a", { href: '#', onClick: () => { var _a; return (_a = uxpContext.eventHandler) === null || _a === void 0 ? void 0 : _a.call(uxpContext, index_1.EventsEnum.WeatherControl, { state: 'clear' }); } },
                        react_1.default.createElement("img", { src: 'https://static.iviva.com/images/Udhayimages/snowflake.png' }))),
                react_1.default.createElement("li", null,
                    react_1.default.createElement("a", { href: '#', onClick: () => { var _a; return (_a = uxpContext.eventHandler) === null || _a === void 0 ? void 0 : _a.call(uxpContext, index_1.EventsEnum.WeatherControl, { state: 'rainy' }); } },
                        react_1.default.createElement("img", { src: "https://static.iviva.com/images/Udhayimages/rainy.png" }))),
                react_1.default.createElement("li", null,
                    react_1.default.createElement("a", { href: '#', onClick: () => { var _a; return (_a = uxpContext.eventHandler) === null || _a === void 0 ? void 0 : _a.call(uxpContext, index_1.EventsEnum.WeatherControl, { state: 'thunder' }); } },
                        react_1.default.createElement("img", { src: "https://static.iviva.com/images/Udhayimages/thunder.png" }))),
                react_1.default.createElement("li", null,
                    react_1.default.createElement("a", { href: '#', onClick: () => { var _a; return (_a = uxpContext.eventHandler) === null || _a === void 0 ? void 0 : _a.call(uxpContext, index_1.EventsEnum.WeatherControl, { state: 'cloud' }); } },
                        react_1.default.createElement("img", { src: "https://static.iviva.com/images/Udhayimages/cloudy-day.png" }))),
                react_1.default.createElement("li", null,
                    react_1.default.createElement("a", { href: '#', onClick: () => { var _a; return (_a = uxpContext.eventHandler) === null || _a === void 0 ? void 0 : _a.call(uxpContext, index_1.EventsEnum.WeatherControl, { state: 'cloud' }); } },
                        react_1.default.createElement("img", { src: "https://static.iviva.com/images/Udhayimages/cloud.png" }))),
                react_1.default.createElement("li", null,
                    react_1.default.createElement("a", { href: '#', onClick: () => { var _a; return (_a = uxpContext.eventHandler) === null || _a === void 0 ? void 0 : _a.call(uxpContext, index_1.EventsEnum.WeatherControl, { state: 'sunny' }); } },
                        react_1.default.createElement("img", { src: "https://static.iviva.com/images/Udhayimages/sun.png" })))))));
};
...
const HeightMap = (props) => {
    ...
    const handleButtonClick = () => {
        var _a;
        (_a = uxpContext.eventHandler) === null || _a === void 0 ? void 0 : _a.call(uxpContext, index_1.EventsEnum.HeightMap, { showHeightMap: true });
        setToggled(!isToggled);
    };
...
const TopNavTabs = (props) => {
    ...
    const handleTabClick = (label) => {
        ...
        (_a = uxpContext.eventHandler) === null || _a === void 0 ? void 0 : _a.call(uxpContext, index_1.EventsEnum.Navigation, { page: 'map' });
    };
...
const SunController_tsx_1 = __importDefault(__webpack_require__(/*! ./components/SunController.tsx */ "./src/components/SunController.tsx.tsx"));
...
(0, uxp_1.registerWidget)({
    id: "sunController",
    widget: SunController_tsx_1.default,
    configs: {
        layout: {
            w: 2,
            h: 9,
