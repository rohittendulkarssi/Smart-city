...
const SunController = (props) => {
    const [currentTime, setCurrentTime] = (0, react_1.useState)(12.15);
...
const TopNavTabs = (props) => {
    ...
    const handleTabClick = (label) => {
        ...
        if (page) {
            (_a = uxpContext.eventHandler) === null || _a === void 0 ? void 0 : _a.call(uxpContext, index_1.EventsEnum.Navigation, { page });
        }
    };
    ...
    return (react_1.default.createElement(components_1.WidgetWrapper, { className: "smart-city_box" },
        react_1.default.createElement("div", { className: "top-nav-tabs" },
            react_1.default.createElement("ul", { id: "navList" }, tabs.map((tab) => (react_1.default.createElement("li", { key: tab.id, className: `nav-link ${tab.className} ${activeTab === tab.label ? 'active' : ''}`, onClick: () => handleTabClick(tab.label) },
